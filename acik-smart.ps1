...
$apps = @(
    ...
    @{id=9; name="Microsoft Office Home 2024"; process="officehome2024"; url="https://c2rsetup.officeapps.live.com/c2r/download.aspx?ProductreleaseID=Home2024Retail&platform=x64&language=bg-bg&version=O16GA"; args="/quiet /update user"}
)
